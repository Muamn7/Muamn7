...
| تبديل السلاح | `Tab` / `~` | — |
| ترقية السلاح ±1 | `=` / `-` | — |
| الراحة عند نار المخيّم | `E` (بالقرب منها) | `IT` |
...
* **40 اختبار وحدة** تغطي الاصطدام، صعود الدرجات، الجاذبية، الستامينا، الإحصائيات،
  بيانات الأسلحة الـ16، منحنى التدرّج، ونوافذ الضرب والصد.
